/* http://prismjs.com/download.html?themes=prism-okaidia&languages=markup+css+clike+javascript+java+php+coffeescript+bash+c+cpp+python+sql+http+go+scala+objectivec+ini&plugins=line-numbers */
...
var _ = self.Prism = {
	...
	highlightAll: function(async, callback) {
		...
		var elements = document.querySelectorAll('pre[class*="language-"], [class*="language-"] pre, pre[class*="lang-"], [class*="lang-"] pre, pre');
